...
export function ProfileStrength({
  ...
  const items = [
    { label: 'Upload CV', done: hasCV, href: '/dashboard/profile?tab=documents' },
    ...
    { label: 'Add Portfolio', done: hasPortfolio, href: '/dashboard/profile?tab=portfolio' },
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      <h3 className="text-sm font-semibold text-slate-900 mb-1">Profile Strength</h3>
